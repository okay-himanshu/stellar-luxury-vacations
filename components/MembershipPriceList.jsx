...
const features = [
  ...
  {
    text: "During School / College Vacations",
  ...
  {
    text: "On Special Days i.e. New Year's Eve",
          ...
          <div className="min-w-[900px]">
            ...
            <div className="space-y-6 mb-8">
              {features.map((item, i) => (
                <div
                  key={i}
                  className="grid grid-cols-[2fr_1fr_1fr_1fr_1fr] gap-4 items-center"
                >
                  ...
                  {item.status.map((isActive, idx) => (
                    <div key={idx} className="flex justify-center">
                      {isActive ? (
                        <Check
                          className="text-[#a3e635] w-8 h-8 font-bold"
                          strokeWidth={4}
                        /> // Neon Green Check
                      ) : (
                        <X
                          className="text-red-500 w-8 h-8 font-bold"
                          strokeWidth={4}
                        /> // Red Cross
                      )}
                    </div>
        ...
        <div className="mt-16 space-y-8 text-left">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">
              Mode of payment Draft, Cheque or Credit Card in Favor of Stellar
              Luxury Vacations Pvt. Ltd.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed max-w-4xl">
              In addition to the prices mentioned above, the member would have
              to pay an Annual Subscription Fee every year (irrespective of the
              usage). The Annual Subscription Fee S2 Apartment Rs. 29,800/- and
              S1 Apartment Rs. 19,500/-.
            </p>
          </div>
