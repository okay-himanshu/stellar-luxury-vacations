      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="text-center mb-16 max-w-5xl mx-auto">
          ...
          <div className="space-y-6 text-gray-400 text-sm md:text-base leading-relaxed">
            <p>
              Indulge in the epitome of luxury and comfort with our spacious
              rooms at Stellar Luxury Vacations. Designed to provide a sanctuary
              of relaxation, our accommodations offer a perfect blend of
              elegance, style, and functionality. Step into a world of opulence
              as you enter your expansive room, meticulously crafted to cater to
              your every need.
            </p>
            <p>
              Experience a sense of grandeur with high ceilings, tasteful
              furnishings, and sophisticated decor that exude an aura of
              refinement. Sink into plush bedding and unwind in a haven of
              tranquility, knowing that every detail has been carefully
              considered to ensure your utmost comfort.
            </p>
          </div>
        </div>
