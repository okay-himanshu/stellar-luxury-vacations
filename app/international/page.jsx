    ...
    const fetchData = async () => {
      try {
        ...
        const citiesRes = await axios.get(
          "/api/cities/region?region=International&limit=1000",
        );
        ...
        if (hotelsRes.data.success) {
          ...
          if (allHotels) {
            const internationalHotels = allHotels.filter(
              (hotel) =>
                hotel.regionType &&
                hotel.regionType.toLowerCase() === "international",
            );

            setHotels(internationalHotels);
            setFilteredHotels(internationalHotels);
          }
        }
      } catch (err) {
